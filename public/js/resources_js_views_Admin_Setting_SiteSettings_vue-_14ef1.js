(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_Admin_Setting_SiteSettings_vue-_14ef1"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*@__PURE__*/Object.assign({
  ...
  setup: function setup(__props, _ref) {
    ...
    /* =========================
       BRANDING FORM
    ========================= */
    var brandingForm = (0,_inertiajs_vue3__WEBPACK_IMPORTED_MODULE_1__.useForm)({
      logo_desktop: null,
      logo_mobile: null
    });
    ...
    /* =========================
       COMMISSION FORM
    ========================= */
    var commissionForm = (0,_inertiajs_vue3__WEBPACK_IMPORTED_MODULE_1__.useForm)({
      direct_percent: (_props$settings$direc = props.settings.direct_percent) !== null && _props$settings$direc !== void 0 ? _props$settings$direc : 0,
      level_percentages: (_props$settings$level = props.settings.level_percentages) !== null && _props$settings$level !== void 0 && _props$settings$level.length ? props.settings.level_percentages : [{
        level: 1,
        percent: 0
      }]
    });
    ...
    function reindexLevels() {
      commissionForm.level_percentages.forEach(function (item, index) {
        item.level = index + 1;
      });
    }
