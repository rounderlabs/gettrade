(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_Account_KYCWizard_vue-_24e31"],{
...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! axios */ "./node_modules/@inertiajs/core/node_modules/axios/lib/axios.js");
// src/router.ts
...
var Config = class {
  ...
  get(key) {
    return (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__["default"])(this.config, key) ? (0,lodash_es__WEBPACK_IMPORTED_MODULE_1__["default"])(this.config, key) : (0,lodash_es__WEBPACK_IMPORTED_MODULE_1__["default"])(this.defaults, key);
  }
...
function mergeDataIntoQueryString(method, href, data, qsArrayFormat = "brackets") {
  ...
  if (hasDataForQueryString) {
    ...
    url.search = qs__WEBPACK_IMPORTED_MODULE_3__.stringify(
      { ...qs__WEBPACK_IMPORTED_MODULE_3__.parse(url.search, parseOptions), ...data },
      {
...
var History = class {
  ...
  clonePageProps(page2) {
    try {
      ...
      return {
        ...page2,
        props: (0,lodash_es__WEBPACK_IMPORTED_MODULE_4__["default"])(page2.props)
      };
    }
  }
  getPageData(page2) {
  ...
  saveScrollPositions(scrollRegions) {
    queue.add(() => {
      return Promise.resolve().then(() => {
        ...
        if ((0,lodash_es__WEBPACK_IMPORTED_MODULE_5__["default"])(this.getScrollRegions(), scrollRegions)) {
          return;
        }
  ...
  saveDocumentScrollPosition(scrollRegion) {
    queue.add(() => {
      return Promise.resolve().then(() => {
        ...
        if ((0,lodash_es__WEBPACK_IMPORTED_MODULE_5__["default"])(this.getDocumentScrollPosition(), scrollRegion)) {
          return;
        }
        return this.doReplaceState({
          page: window.history.state.page,
...
var PrefetchedRequests = class {
  ...
  withoutPurposePrefetchHeader(params) {
    const newParams = (0,lodash_es__WEBPACK_IMPORTED_MODULE_4__["default"])(params);
...
var Response = class _Response {
  ...
  preserveEqualProps(pageResponse) {
    ...
    Object.entries(pageResponse.props).forEach(([key, value]) => {
      if ((0,lodash_es__WEBPACK_IMPORTED_MODULE_5__["default"])(value, currentPageProps[key])) {
...
var Router = class {
  ...
  replaceProp(name, value, options) {
    this.replace({
      ...
      props(currentProps) {
        ...
        return (0,lodash_es__WEBPACK_IMPORTED_MODULE_2__["default"])((0,lodash_es__WEBPACK_IMPORTED_MODULE_4__["default"])(currentProps), name, newValue);
      },
      ...options || {}
    });
  }
  ...
  getPendingVisit(href, options, pendingVisitOptions = {}) {
    ...
    const configuredOptions = defaultVisitOptionsCallback ? defaultVisitOptionsCallback(href.toString(), (0,lodash_es__WEBPACK_IMPORTED_MODULE_4__["default"])(options)) || {} : {};
    const mergedOptions = {
      method: "get",
      data: {},
      replace: false,
...
function formDataToObject(source) {
  ...
  for (const [key, value] of source.entries()) {
    ...
    (0,lodash_es__WEBPACK_IMPORTED_MODULE_2__["default"])(form, path, value);
  }
  return form;
}
...
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lodash-es */ "./node_modules/lodash-es/set.js");
...
function useForm(rememberKeyOrData, maybeData) {
  ...
  const form = (0,vue__WEBPACK_IMPORTED_MODULE_1__.reactive)({
    ...
    data() {
      return Object.keys(defaults).reduce((carry, key2) => {
        return (0,lodash_es__WEBPACK_IMPORTED_MODULE_3__["default"])(carry, key2, (0,lodash_es__WEBPACK_IMPORTED_MODULE_4__["default"])(this, key2));
      }, {});
    },
    transform(callback) {
      transform = callback;
    ...
    defaults(fieldOrFields, maybeValue) {
      ...
      if (typeof fieldOrFields === "undefined") {
        ...
        defaults = typeof fieldOrFields === "string" ? (0,lodash_es__WEBPACK_IMPORTED_MODULE_3__["default"])((0,lodash_es__WEBPACK_IMPORTED_MODULE_2__["default"])(defaults), fieldOrFields, maybeValue) : Object.assign({}, (0,lodash_es__WEBPACK_IMPORTED_MODULE_2__["default"])(defaults), fieldOrFields);
      }
      return this;
    },
    reset(...fields) {
      ...
      if (fields.length === 0) {
        ...
        fields.filter((key2) => (0,lodash_es__WEBPACK_IMPORTED_MODULE_5__["default"])(clonedData, key2)).forEach((key2) => {
          (0,lodash_es__WEBPACK_IMPORTED_MODULE_3__["default"])(defaults, key2, (0,lodash_es__WEBPACK_IMPORTED_MODULE_4__["default"])(clonedData, key2));
          (0,lodash_es__WEBPACK_IMPORTED_MODULE_3__["default"])(this, key2, (0,lodash_es__WEBPACK_IMPORTED_MODULE_4__["default"])(resolvedData, key2));
        });
      }
      return this;
    },
  ...
  (0,vue__WEBPACK_IMPORTED_MODULE_1__.watch)(
    form,
    (newValue) => {
      form.isDirty = !(0,lodash_es__WEBPACK_IMPORTED_MODULE_6__["default"])(form.data(), defaults);
      if (rememberKey) {
  ...
  if (isServer && render) {
    const body = await render(
      (0,vue__WEBPACK_IMPORTED_MODULE_1__.createSSRApp)({
        render: () => (0,vue__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
          id,
...
/* harmony import */ var _layouts_UserLayouts_UserLayout_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/layouts/UserLayouts/UserLayout.vue */ "./resources/js/layouts/UserLayouts/UserLayout.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*@__PURE__*/Object.assign({
  layout: _layouts_UserLayouts_UserLayout_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
  name: "KYCWizard"
}, {
  __name: 'KYCWizard',
  props: {
  ...
  setup: function setup(__props, _ref) {
    ...
    var __returned__ = {
      ...
      UserLayout: _layouts_UserLayouts_UserLayout_vue__WEBPACK_IMPORTED_MODULE_2__["default"]
    };
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/views/Account/KYCWizard.vue?vue&type=template&id=085386ef":
/*!**********************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/views/Account/KYCWizard.vue?vue&type=template&id=085386ef ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Card "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [_cache[11] || (_cache[11] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h4", {
    "class": "mb-1"
  }, "KYC Verification", -1 /* HOISTED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Progress Bar "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "progress-bar",
    role: "progressbar",
    style: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeStyle)({
      width: $setup.progress + '%'
    })
  }, null, 4 /* STYLE */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Step labels "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)({
  ...
  }, "Bank", 2 /* CLASS */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" ======================================================\n                           STEP 1 – AADHAAR\n                        ====================================================== "), $setup.step === 1 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("form", {
    key: 0,
    onSubmit: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)($setup.submitStep1, ["prevent"])
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_9, [_cache[12] || (_cache[12] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "form-label"
  ...
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.aadhaarForm.aadhaar_number]]), $setup.aadhaarForm.errors.aadhaar_number ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_10, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.aadhaarForm.errors.aadhaar_number), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_11, [_cache[13] || (_cache[13] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "form-label"
  ...
  }, null, 32 /* NEED_HYDRATION */), $setup.aadhaarForm.errors.aadhaar_front ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_12, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.aadhaarForm.errors.aadhaar_front), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_13, [_cache[14] || (_cache[14] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "form-label"
  ...
  }, null, 32 /* NEED_HYDRATION */), $setup.aadhaarForm.errors.aadhaar_back ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_14, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.aadhaarForm.errors.aadhaar_back), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    "class": "btn btn-primary",
    disabled: $setup.aadhaarForm.processing
  }, " Save & Continue ", 8 /* PROPS */, _hoisted_15)], 32 /* NEED_HYDRATION */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" ======================================================\n                           STEP 2 – PAN\n                        ====================================================== "), $setup.step === 2 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("form", {
    key: 1,
    onSubmit: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)($setup.submitStep2, ["prevent"])
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_16, [_cache[15] || (_cache[15] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "form-label"
  ...
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.panForm.pan_number]]), $setup.panForm.errors.pan_number ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_17, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.panForm.errors.pan_number), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_18, [_cache[16] || (_cache[16] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "form-label"
  ...
  }, null, 32 /* NEED_HYDRATION */), $setup.panForm.errors.pan_file ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_19, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.panForm.errors.pan_file), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_20, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
  ...
  }, " Save & Continue ", 8 /* PROPS */, _hoisted_21)])], 32 /* NEED_HYDRATION */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" ======================================================\n                           STEP 3 – BANK\n                        ====================================================== "), $setup.step === 3 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("form", {
    key: 2,
    onSubmit: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)($setup.submitStep3, ["prevent"])
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_22, [_cache[17] || (_cache[17] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "form-label"
  ...
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.bankForm.bank_name]]), $setup.bankForm.errors.bank_name ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_23, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.bankForm.errors.bank_name), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_24, [_cache[18] || (_cache[18] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "form-label"
  ...
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.bankForm.ifsc_code]]), $setup.bankForm.errors.ifsc_code ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_25, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.bankForm.errors.ifsc_code), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_26, [_cache[19] || (_cache[19] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "form-label"
  ...
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.bankForm.account_number]]), $setup.bankForm.errors.account_number ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_27, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.bankForm.errors.account_number), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_28, [_cache[20] || (_cache[20] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "form-label"
  ...
  }, null, 32 /* NEED_HYDRATION */), $setup.bankForm.errors.cancel_cheque ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_29, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.bankForm.errors.cancel_cheque), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_30, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "btn btn-secondary",
  ...
  }, " Submit KYC ", 8 /* PROPS */, _hoisted_31)])], 32 /* NEED_HYDRATION */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])])])])]);
}
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _KYCWizard_vue_vue_type_template_id_085386ef__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./KYCWizard.vue?vue&type=template&id=085386ef */ "./resources/js/views/Account/KYCWizard.vue?vue&type=template&id=085386ef");
...
;
const __exports__ = /*#__PURE__*/(0,_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_KYCWizard_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_KYCWizard_vue_vue_type_template_id_085386ef__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/views/Account/KYCWizard.vue"]])
/* hot reload */
if (false) {}
...
/***/ "./resources/js/views/Account/KYCWizard.vue?vue&type=template&id=085386ef":
/*!********************************************************************************!*\
  !*** ./resources/js/views/Account/KYCWizard.vue?vue&type=template&id=085386ef ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_KYCWizard_vue_vue_type_template_id_085386ef__WEBPACK_IMPORTED_MODULE_0__.render)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_KYCWizard_vue_vue_type_template_id_085386ef__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./KYCWizard.vue?vue&type=template&id=085386ef */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/views/Account/KYCWizard.vue?vue&type=template&id=085386ef");
