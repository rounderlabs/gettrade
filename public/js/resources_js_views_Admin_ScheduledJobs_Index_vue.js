(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_Admin_ScheduledJobs_Index_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(props) {
    ...
    var toggle = function toggle(id) {
      if (!id) return;
      _inertiajs_vue3__WEBPACK_IMPORTED_MODULE_2__.router.patch("/admin/scheduled/jobs/".concat(id, "/toggle"), {}, {
        preserveScroll: true
      });
    };
    var runNow = function runNow(id) {
      if (!id) return;
      _inertiajs_vue3__WEBPACK_IMPORTED_MODULE_2__.router.post(route("admin.scheduled.jobs.run-now", id), {}, {
        preserveScroll: true
      });
    };
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 4;
              _context.next = 7;
              return axios__WEBPACK_IMPORTED_MODULE_3__["default"].get(route("admin.scheduled.jobs.logs", job.id));
            case 7:
              res = _context.sent;
