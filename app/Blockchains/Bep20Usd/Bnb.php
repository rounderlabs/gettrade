...
namespace App\Blockchains\Bep20Usd;

use App\Blockchains\Bep20Usd\PEMHelper;
use App\Blockchains\Bep20Usd\ProxyApi;
use App\Blockchains\Bep20Usd\Utils;
...
class Bnb
{
    ...
    {
        return Utils::toWei((string)'1', 'gwei');
...
//           // return Utils::toWei((string)$res['result'][$type . 'gaspricegwei'], 'gwei');
//        } else {
//            return $res;
//        }
    }
