...
class CreateAutoDividendWithdrawHistoryJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $amount = addDecimalStrings($this->userIncomeOnHold->roi, $this->userIncomeOnHold->roi_on_roi, 2);
