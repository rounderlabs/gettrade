...
{{--    <link rel="manifest" href="./manifest.json"/>--}}
    ...
    <!-- iconsax css -->
    <link rel="stylesheet" type="text/css" href="/shuchack/assets-panel/assets/css/iconsax.css"></link>


    <!-- bootstrap css -->
    <link rel="stylesheet" id="rtl-link" type="text/css"
          href="/shuchack/assets-panel/assets/css/bootstrap.min.css"></link>

    <!-- swiper css -->
    <link rel="stylesheet" type="text/css" href="/shuchack/assets-panel/assets/css/swiper-bundle.min.css"></link>

    <!-- Theme css -->
    <link rel="stylesheet" id="change-link" type="text/css" href="/shuchack/assets-panel/assets/css/style.css"></link>
    <script>
...
{{--        <div class="app-info">--}}
{{--            <img src="/shuchack/assets-panel/assets/images/logo/48.png" class="img-fluid" alt=""/>--}}
{{--            <div class="content">--}}
...
<!-- swiper js -->
<script src="/shuchack/assets-panel/assets/js/swiper-bundle.min.js"></script>
<script src="/shuchack/assets-panel/assets/js/custom-swiper.js"></script>

<!-- feather js -->
<script src="/shuchack/assets-panel/assets/js/feather.min.js"></script>
<script src="/shuchack/assets-panel/assets/js/custom-feather.js"></script>

<!-- iconsax js -->
<script src="/shuchack/assets-panel/assets/js/iconsax.js"></script>

<!-- bootstrap js -->
<script src="/shuchack/assets-panel/assets/js/bootstrap.bundle.min.js"></script>

<!-- homescreen popup js -->
<script src="/shuchack/assets-panel/assets/js/homescreen-popup.js"></script>

<!-- PWA offcanvas popup js -->
<script src="/shuchack/assets-panel/assets/js/offcanvas-popup.js"></script>

<!-- script js -->
<script src="/shuchack/assets-panel/assets/js/script.js"></script>
