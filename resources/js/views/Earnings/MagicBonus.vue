<template>
    <section class="section-b-space">
        <div class="custom-container">
            <div class="title">
                <h2>Maturity Bonus</h2>
            </div>

            <div class="row gy-3">

                <div v-if="!magic_bonuses.length" class="col-12">
    ...
    <Paginator :base-url="route('earnings.magic.bonus.get')" @pageMeta="paginatorPageMeta"
...
export default {
    ...
    setup(props) {
        ...
        return {
            paginatorResponse, paginatorPageMeta, pageMeta, magic_bonuses
        }
    }
}
</script>
