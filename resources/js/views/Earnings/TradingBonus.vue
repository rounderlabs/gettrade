                    ...
                    <div class="transaction-box">
                        <a href="" class="d-flex gap-3">
                            <div class="transaction-image color5">
                                <img class="img-fluid icon" src="/user-panel/assets-panel/assets/images/wallet-svg-fill.svg" alt="tether">
                            </div>
...
export default {
    ...
    setup(props) {
        ...
        return {
            paginatorResponse, paginatorPageMeta, pageMeta, monthly_roi_bonuses, currencySymbol
        }
    }
}
</script>
