<template>
    <section class="section-b-space">
        <div class="custom-container">
            ...
            <div class="row gy-3">
                ...
                <div v-if="!pool_bonuses.length" class="col-12">
                ...
                <div v-for="(bonus,index) in pool_bonuses" class="col-12">
                    <div class="transaction-box">
                        <a href="" class="d-flex gap-3">
    ...
    <Paginator :base-url="route('earnings.pool.bonus.get')" @pageMeta="paginatorPageMeta"
...
export default {
    ...
    setup(props) {
        ...
        return {
            paginatorResponse, paginatorPageMeta, pageMeta, pool_bonuses
        }
    }
}
</script>
