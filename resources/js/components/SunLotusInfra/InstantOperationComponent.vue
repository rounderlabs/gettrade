                ...
                <li>
                    <Link :href="route('deposit.add.fund')">
                        <div class="categories-box">
                            <vue-feather type="plus-circle" class="categories-icon"></vue-feather>
                        </div>
                        <h5 class="mt-2 text-center">Add Fund</h5>
                    </Link>
                </li>
                <li>
                    <Link :href="route('wallet.ledger')">
                        <div class="categories-box">
                            <vue-feather type="file-text" class="categories-icon"></vue-feather>
                        </div>
                        <h5 class="mt-2 text-center">Ledger</h5>
                    </Link>
                </li>
                <li>
